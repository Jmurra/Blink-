...
lying besides the dirt path");

var sleep = prompt ("Do you wish to try and get some rest and continue the
search tomorrow? 'y' is  yes and 'n' is no");

if (sleep = "y")
{
  console.log("You decided to try and get some rest and woke up feeling
  replishined in the morning ");
}
else {
...
console.log ("Suddenly you feel a cold metal hand grasp your ankle, you try and run but their
is just know use. if only you could find some type of object to pry yourself free.")
...
if (freedom = "r" ) {
  console.log("You look to the right, there's nothing there but dirt.");
    ...
    console.log("You look to the left and find a rusty pry bar,
  by your side");
  }

else {
  console.log("Try using the 'l' arrow key to look left and the 'r'
  arrow key to to look right'..");
}

var escape = prompt("You think to yourself i could take this robot if want
 or i could just escape without the risk..");
 ...
 if  (escape = "f") {
   ...
   console.log("Try using the 'f' arrow key to fight the robot or you can run by
    using the 'r' arrow key");
 }
